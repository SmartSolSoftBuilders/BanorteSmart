set rtc_cred = getcredential("RTC_2");
...
set descargar = descargar_archivos($RTC_USER,$RTC_PASS,"DataDev","D:\OpenMake\DATAPOWER\Archivos\Desarrollo\${version}","https://lnxsclm0p.unix.banorte.com:9443/ccm","D:\Program Files\IBM\TeamConcert","WS_DESARROLLO","MCA_Desarrollo");
echo $descargar;
set subir = subir_DP_bat("D:\OpenMake\DATAPOWER\curl\bin\curl.exe","D:\OpenMake\DATAPOWER\xmls\uploadfile.xml","D:\OpenMake\DATAPOWER\xmls\des_uploadfile.xml","D:\OpenMake\DATAPOWER\Archivos\Desarrollo\${version}\MCA_Desarrollo\DESARROLLO","MCA_Desarrollo","local:///",$DP_USER,$DP_PASS,"https://lnxsdtp1d.dev.unix.banorte.com:5550/service/mgmt/current");
echo $subir;
